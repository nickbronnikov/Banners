    ...
    <div class="container body-add">
        <div class="row">
            <div class="col-md-6 col-sm-12 offset-md-3">
                <h2 class="text-center"><i class="fa fa-pencil-square-o"></i> {$localisation.edit.h2}:</h2>
                <div class="card">
                    <div class="card-body">
                        <div class="form-group">
                            <label for="name">{$localisation.add.form.name.label}</label>
                            <input type="text" class="form-control" value="{$banner.name}" id="name" placeholder="{$localisation.add.form.name.placeholder}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" id="url" value="{$banner.url}" placeholder="{$localisation.add.form.url.placeholder}">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="custom-select" id="state">
                                <option value="0">{$localisation.add.form.state.placeholder}</option>
                                <option value="1" {if $banner.state == 1}selected{/if}>{$localisation.add.form.state.options[0]}</option>
                                <option value="2" {if $banner.state == 2}selected{/if}>{$localisation.add.form.state.options[1]}</option>
                                <option value="3" {if $banner.state == 3}selected{/if}>{$localisation.add.form.state.options[2]}</option>
                            </select>
                            <small id="stateHelp" class="form-text text-danger"></small>
                        </div>
                        <div class="form-group">
                            <label for="sort">{$localisation.add.form.sort.label}:</label>
                            <input type="number" min="1" value="{$banner.sort}" class="form-control" id="sort" placeholder="{$localisation.add.form.sort.placeholder}">
